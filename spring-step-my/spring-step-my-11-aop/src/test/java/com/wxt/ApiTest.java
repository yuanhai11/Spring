...
import com.wxt.service.IUserService;
import com.wxt.service.UserService;
import com.wxt.service.UserServiceInterceptor;
...
public class ApiTest {
    ...
    public void test_dynamic() {
        ...
        advisedSupport.setMethodMatcher(new AspectJExpressionPointcut("execution(* com.wxt.service.IUserService.*(..))"));
    ...
    public void test() {
        ...
        IUserService proxy = (IUserService)Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            ...
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* com.wxt.service.IUserService.*(..))");
